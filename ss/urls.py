...
urlpatterns = [
    ...
    path('incidences/manage/', PendingIncidencesView.as_view(), name='admin_incidences'),
    path('incidences/manage/<int:pk>/resolve/', ResolveIncidenceView.as_view(), name='resolve_incidence'),
